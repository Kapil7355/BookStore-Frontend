...
export default function Navbar() {
  ...
  return (
    <>
    <div className={` max-w-screen-2xl container mx-auto md:px-40 py-4 fixed top-0 z-50 left-0 right-0 
     ${sticky ?
    'sticky-navbar shadow-md bg-base-200 transition-all duration-300 ':''
    }`}>
